...
/**
 * Computes the Binary Cross-Entropy (BCE) loss and gradients for binary classification tasks. It is
 * defined as: {@code E = -sum(y * log(h) + (1 - y) * log(1 - h))}.
 */
public final class BinaryCrossEntropyLossFunction implements LossFunction {
  ...
  public String toString() {
    return "BinaryCrossEntropy: -sum(y * log(h) + (1 - y) * log(1 - h))";
  }
}
